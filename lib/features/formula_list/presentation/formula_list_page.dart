    ...
    return Scaffold(
      ...
      body: Consumer<FormulaListProvider>(
          ...
          return Column(
            ...
            children: [
              Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  Text('No formulas found in the database.')
                ],
              ),
            ],
          );
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return ListTile(
                      ...
                      trailing: IconButton(
                        ...
                        onPressed: () async {
                          final formulaProvider = Provider.of<FormulaListProvider>(
                              context,
                              listen: false);
                          ...
                          // if (confirm == true) {
                          //   await formulaProvider.deleteFormula(formula['id']);
                          //   formulaProvider
                          //       .fetchFormulas(); // Refresh the formula list after deletion
                          // }
                        },
                      ),
                      onTap: () {
       ...
       floatingActionButton: FloatingActionButton(
        onPressed: () {
          // Define the action for the FAB (e.g., navigate to add formula page)
        },
